    ...
    <section id="overview" className="relative pt-28 sm:pt-36 pb-16 sm:pb-24 overflow-hidden border-b border-white/10 bg-[#0B0A0D]">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 max-w-7xl">
        ...
        <div className="mt-20 pt-8 border-t border-white/10">
          <p className="text-center text-xs font-mono uppercase tracking-[0.25em] text-white/40 mb-6">
            Trusted by brands running video across formats
          </p>
          ...
          <div className="relative overflow-hidden w-full mask-gradient">
            <div className="flex items-center gap-12 whitespace-nowrap animate-marquee">
              {brandLogos.concat(brandLogos).map((logo, idx) => (
                <div
                  key={`${logo}-${idx}`}
                  className="px-5 py-2.5 rounded-xl border border-white/5 bg-white/[0.02] text-xs font-heading font-bold tracking-widest text-white/50 hover:text-white hover:border-white/20 transition-all cursor-default"
                >
                  {logo}
                </div>
              ))}
