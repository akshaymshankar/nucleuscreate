...
const ProcessSection = () => {
  ...
  return (
    <section id="process" className="relative py-24 sm:py-32 border-t border-border/40 bg-background overflow-visible">
      {/* Background Glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full pointer-events-none overflow-hidden">
        <motion.div 
          ...
          style={{ background: "radial-gradient(circle, hsl(134 68% 45%), transparent 70%)" }}
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 flex flex-col items-center justify-center">
        ...
        <div className="relative mx-auto w-full max-w-[500px] lg:max-w-[650px] [perspective:2000px]">
          <motion.div 
            ...
            whileInView={{ scale: 1, y: 0, rotateX: 5 }}
